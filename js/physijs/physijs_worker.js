...
var	
	...
	new_sim = false; //If we're dealing with a new simulation.
...
if ( description.children ) {
	...
	// Fix suggested by efaj on Github: https://github.com/chandlerprall/Physijs/issues/107
...
public_functions.simulate = function simulate( params ) {
	if ( world ) {
		while(Date.now() - last_simulation_time < 4 && !new_sim) {
