...
function quadruped() {
	...
	var ver_leg_2 = new THREE.CubeGeometry( 6.0, 0.75, 0.75 );
	...
	this.createRobot = function(validate) {
		...
		// 45 degree triangle hypotenuse for the legs.
		var hyp = 8.48528137
		...
		box.position.set(6.5-(hyp/4.0),body_height-(hyp/4.0),-2.375);
		box.scale.set(1,1,1);
		box.castShadow = true;
		box.rotation.set(0,0,Math.radians(-45));
		Simulator.scene().add( box );
		quadruped.push( box );

		// Create Hinge between Front Body and Left Leg
		var hinge = new Physijs.HingeConstraint(quadruped[0],quadruped[5],new THREE.Vector3(6.5,body_height,-2),new THREE.Vector3(0,0,1));
		Simulator.scene().addConstraint(hinge);
		constraints.push(hinge);
		...
		var hinge = new Physijs.HingeConstraint(quadruped[0],quadruped[6],new THREE.Vector3(6.5,body_height,2),new THREE.Vector3(0,0,1));
		Simulator.scene().addConstraint(hinge);
		constraints.push(hinge);
		hinge.setLimits(-joint_range,joint_range,bias,relaxation);
		...
		var hinge = new Physijs.HingeConstraint(quadruped[4],quadruped[7],new THREE.Vector3(-6.5,body_height,-2),new THREE.Vector3(0,0,-1));
		Simulator.scene().addConstraint(hinge);
		constraints.push(hinge);
		hinge.setLimits(-joint_range,joint_range,bias,relaxation);
		...
		var hinge = new Physijs.HingeConstraint(quadruped[4],quadruped[8],new THREE.Vector3(-6.5,body_height,2),new THREE.Vector3(0,0,-1));
		Simulator.scene().addConstraint(hinge);
		constraints.push(hinge);
		hinge.setLimits(-joint_range,joint_range,bias,relaxation);
		...
		box.position.set(6.5-(hyp/4.0),body_height-(3.0*hyp/4.0),-2.375);
		box.scale.set(1,1,1);
		box.castShadow = true;
		box.rotation.set(0,0,Math.radians(-45));
		Simulator.scene().add( box );
		...
		var hinge = new Physijs.HingeConstraint(quadruped[5],quadruped[9],new THREE.Vector3(6.5-(hyp/2.0),body_height-(hyp/2.0),-2),new THREE.Vector3(0,0,1));
		Simulator.scene().addConstraint(hinge);
		constraints.push(hinge);
		hinge.setLimits(-joint_range,joint_range,bias,relaxation);
		...
		var hinge = new Physijs.HingeConstraint(quadruped[6],quadruped[10],new THREE.Vector3(6.5-(hyp/2.0),body_height-(hyp/2.0),2),new THREE.Vector3(0,0,1));
		Simulator.scene().addConstraint(hinge);
		constraints.push(hinge);
		hinge.setLimits(-joint_range,joint_range,bias,relaxation);
		...
		var hinge = new Physijs.HingeConstraint(quadruped[7],quadruped[11],new THREE.Vector3(-6.5+(hyp/2.0),body_height-(hyp/2.0),-2),new THREE.Vector3(0,0,-1));
		Simulator.scene().addConstraint(hinge);
		constraints.push(hinge);
		hinge.setLimits(-joint_range,joint_range,bias,relaxation);
		...
		var hinge = new Physijs.HingeConstraint(quadruped[8],quadruped[12],new THREE.Vector3(-6.5+(hyp/2.0),body_height-(hyp/2.0),2),new THREE.Vector3(0,0,-1));
		Simulator.scene().addConstraint(hinge);
		constraints.push(hinge);
		hinge.setLimits(-joint_range,joint_range,bias,relaxation);
